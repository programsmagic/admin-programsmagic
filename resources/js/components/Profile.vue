            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-header text-white"
                         style="background: url('/img/background/bg1.jpg') center center;">
                            ...
                            <div class="tab-pane active" id="settings">
                                <form class="form-horizontal" @submit.prevent="updateProfile">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" v-model="form.email" class="form-control"
                                                   id="inputEmail" :class="{ 'is-invalid': form.errors.has('email') }"
                                                   placeholder="Email">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" class="form-control" style="border:hidden;"
                                                   @change="uploadImage" id="photo" name="photo" placeholder="Skills">
                                        </div>
                                    </div>
                                    <div class="form-group row">
    ...
    export default {
        ...
        methods: {
            profileImage: function () {
                let photo;
                if (this.form.photo) {
                     photo = (this.form.photo.length > 100) ? this.form.photo : '/img/profile/' + this.form.photo;
                } else {
                     photo = "";
                }
                return photo;
